...
catalogo <- tribble(
  ...
  "rar; zip",
  "Archivos anuales: .rar en 2011-2025 y .zip en 2019. url_descarga apunta al ano 2025, subido en 2025/12. La carpeta de subida varia por ano, de modo que la serie exige leer cada enlace en la pagina. La copia local del ano 2025 es .csv de 151,4 MB, separador punto y coma, cabecera en UTF-8 con marca de orden de bytes (BOM), 49 columnas. Incluye latitud y longitud del establecimiento.",
  "Estudiante", "MRUN; RBD; AGNO; COD_COM_ESTAB", "Establecimiento",
  "2011-2025 en el portal; 2011-2025 en la copia local, serie completa",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registros ER_Educacion_parvularia_Oficial_WEB.pdf, presente en la copia local y no publicado en la pagina",
  "NA",
  "Matricula del nivel parvulario del territorio.",
  "Verificada", HOY,
  "Resuelta en la segunda pasada de doble fuente: la pagina no publica esquema de registros, pero la copia local si lo trae como PDF junto al dato. Columnas, separador, codificacion y anos efectivos leidos de la copia local (solo cabecera).",
  ...
  "mrun; cod_nivel; es_mujer; prioritario; alto_rendimiento; lat_con_error; lon_con_error; calidad_georef",
  DA, CEM, "Portal de datos abiertos", "Abierto",
  ...
  "rar; zip",
  "Archivos comprimidos anuales, .rar y .zip, 2016-2025. url_descarga apunta al ano 2025, subido en 2026/03. Cada ano trae varios archivos por etapa (oferta, postulantes, postulaciones, resultados, relaciones entre postulantes). Las columnas declaradas corresponden al archivo B1 de postulantes de etapa regular del proceso 2025, .csv de 19 MB, separador punto y coma, UTF-8, 8 columnas. La georreferenciacion del postulante viene con error deliberado (lat_con_error, lon_con_error).",
  "Estudiante", "mrun; cod_nivel", "Establecimiento",
  "2016-2025 en el portal; 2016-2025 en la copia local, serie completa",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registros ER_Admision_A1 y variantes por ano, presentes en la copia local",
  "NA",
  "Postulaciones y resultados de admision; insumo de demanda por establecimiento.",
  "Verificada", HOY,
  "Resuelta en la segunda pasada de doble fuente. El conjunto no es un archivo unico por ano sino una familia de archivos por etapa; las columnas declaradas son las de uno solo, y los demas archivos tienen esquemas propios que no se transcriben aqui.",
  "slep_estudio_oferta_demanda",
  ...
  "Asistencia declarada mensual por ano",
  "Asistencia mensual declarada por estudiante, construida desde el Sistema de Informacion General de Estudiantes (SIGE), con dias asistidos, dias trabajados y asistencia promedio del mes.",
  "AGNO; MES_ESCOLAR; RBD; DGV_RBD; NOM_RBD; COD_REG_RBD; NOM_REG_RBD_A; COD_PRO_RBD; COD_COM_RBD; NOM_COM_RBD; COD_DEPROV_RBD; NOM_DEPROV_RBD; RURAL_RBD; NOMBRE_SLEP; COD_DEPE; COD_DEPE2; COD_ENSE; COD_ENSE2; COD_GRADO; LET_CUR; MRUN; GEN_ALU; FEC_NAC_ALU; COD_COM_ALU; NOM_COM_ALU; DIAS_ASISTIDOS12; DIAS_TRABAJADOS; ASIS_PROMEDIO",
  DA, CEM,
  "Portal de datos abiertos", "Abierto", PORTAL_DA, "NA", "NA",
  "28 variables declaradas en el esquema de registro del emisor. Unidad responsable: Unidad de Estadisticas del Centro de Estudios. La unidad basica es el registro, no el estudiante: un alumno puede tener mas de un registro por cambio de establecimiento, de curso o de nivel dentro del mismo mes.",
  "Estudiante", "MRUN; RBD; AGNO; MES_ESCOLAR", "Establecimiento",
  "2023 a marzo de 2026 segun el esquema de registro consultado",
  "Mensual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registro er_asistencia_mensual_2026_web.pdf, 22 paginas, en copia local; no publicado como URL en la pagina del portal",
  "NA",
  "Asistencia mensual, insumo central de la minuta de asistencia del Area.",
  "Declarada sin verificar", "NA",
  "Listada en la seccion Estudiantes del portal y ausente del reconocimiento. El estado se mantiene porque su pagina propia no se abrio; la ESTRUCTURA si quedo verificada en el barrido de esquemas de registro, leyendo el documento del propio emisor en copia local. El emisor declara que la entrega es mensual sin fecha fija.",
  "slep_seguimiento_educacion_inicial",

  "F017", "1. Comunidades educativas", "1.1 Trayectorias estudiantiles",
  "Asistencia anual por estudiante",
  "Asistencia anual por estudiante, agregada desde las bases de asistencia mensual, con dias asistidos por mes, dias asistidos del ano, tasa de asistencia anual y su categoria.",
  "AGNO; MRUN; RBD; COD_REG_RBD; NOM_REG_RBD_A; COD_PRO_RBD; COD_COM_RBD; NOM_COM_RBD; COD_DEPROV_RBD; NOM_DEPROV_RBD; RURAL_RBD; COD_DEPE2; COD_ENSE; COD_ENSE2; COD_GRADO; LET_CUR; GEN_ALU; FEC_NAC; DIAS_ASISTIDOS_3 a DIAS_ASISTIDOS_12; DIAS_ASISTIDOS_ANUAL; TASA_ASISTENCIA_ANUAL; CATEGORIA_ASIS_ANUAL; SLEP; NOMBRE_SLEP; COHORTE",
  DA, CEM,
  "Portal de datos abiertos", "Abierto", PORTAL_DA, "NA", "NA",
  "El esquema de registro del emisor declara el bloque DIAS_ASISTIDOS_3 a DIAS_ASISTIDOS_12 como una variable por mes, de marzo a diciembre; se abrevia por rango. Fuente declarada: Sistema de Informacion General de Estudiantes (SIGE). Fecha de la informacion del esquema consultado: 31 de enero de 2026. Las observaciones excluyen a estudiantes de establecimientos particulares pagados, que no reportan asistencia mensual.",
  "Estudiante", "MRUN; RBD; AGNO", "Establecimiento",
  "2015-2019; 2022-2025. Serie discontinua: sin 2020 ni 2021",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registro ER_Asistencia_anual_PUB.pdf, 19 paginas, en copia local; no publicado como URL en la pagina del portal",
  "NA",
  ...
  "Notas y egresados de ensenanza media",
  "Promedio de notas y marca de egreso de estudiantes de ensenanza media, con el establecimiento de egreso y el identificador enmascarado del estudiante.",
  "AGNO; RBD; DGV_RBD; COD_REG_RBD; NOM_REG_RBD_A; COD_PRO_RBD; COD_COM_RBD; NOM_COM_RBD; COD_DEPROV_RBD; NOM_DEPROV_RBD; COD_ENSE; COD_GRADO; COD_DEPE; COD_DEPE2; RURAL_RBD; MRUN; MRUN_IPE; PROM_NOTAS_ALU; ORIGEN; ENSE_COMPLETA; MARCA_EGRESO",
  DA, CEM,
  "Portal de datos abiertos", "Abierto", PORTAL_DA, "NA", "csv",
  "21 variables declaradas en el esquema de registro del emisor. Trae dos identificadores enmascarados distintos, MRUN y MRUN_IPE, lo que permite enlazar con el registro de admision a la educacion superior. La copia local cubre 2023, 2024 y 2025.",
  "Estudiante", "MRUN; MRUN_IPE; RBD; AGNO", "Establecimiento",
  "2023-2025 en la copia local; el rango del portal no se observo",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registro er_notas_y_egresados_ensenanza_media_publ_2025.pdf, 8 paginas, en copia local; no publicado como URL en la pagina del portal",
  "NA",
...
catalogo_t2 <- tribble(
  ...
  "Sin periodicidad definida", "NA", "NA", "NA",
...
catalogo_t5 <- tribble(
  ...
  "AGNO_EVAL; RBD; DGV_RBD; NOM_RBD; COD_REG_RBD; NOM_REG_RBD_A; COD_PRO_RBD; COD_COM_RBD; NOM_COM_RBD; COD_DEPROV_RBD; NOM_DEPROV_RBD; COD_DEPE; COD_DEPE2; RURAL_RBD; ESTADO_ESTAB; MRUN; DOC_GENERO; DOC_FEC_NAC; NIVEL; PF_PJE; PF_ESC; PF_CAT_CARRERA",
  DA, CEM, "Portal de datos abiertos", "Abierto",
  ...
  "rar; zip",
  "Archivos anuales .rar y .zip, 2004-2024. url_descarga apunta al ano 2024, subido en 2026/03. La copia local del ano 2024 es .csv de 2,9 MB, separador punto y coma, UTF-8, 22 columnas. Incluye puntaje del Portafolio (PF_PJE), su escala (PF_ESC) y el tramo de carrera resultante (PF_CAT_CARRERA).",
  "Docente o asistente", "MRUN; RBD; AGNO_EVAL", "Establecimiento",
  "2004-2024 en el portal; 2004-2024 en la copia local, serie completa",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Esquema de registros ER_Evaluacion_Docente_PUBL_CLAVE.pdf, presente en la copia local",
  "NA",
  "Resultados de evaluacion docente por establecimiento; insumo de dotacion.",
  "Verificada", HOY,
  "La serie termina en 2024, un ano antes que las bases de estudiantes del mismo portal. Resuelta en la segunda pasada de doble fuente: la copia local trae la serie completa y su esquema de registros.",
  "slep_estudio_oferta_demanda",
  ...
  "ID; ANYO_PROCESO; COD_CARRERA; COD_UNIVERSIDAD; bloques EXPERIENCIAPREVIA1 a EXPERIENCIAPREVIA5_9; PRIMERA_GENERACION_1; PRIMERA_GENERACION_2; bloques CCEA3_ a CCEA12_",
  "Portal Bases de Datos", DEMRE,
  "Descarga directa desde sitio institucional", "Abierto",
  "https://demre.cl/portales/portal-bases-datos", "NA", "csv",
  ...
  "Estudiante", "ID; ANYO_PROCESO", "Establecimiento",
  "2023-2026 en la copia local; el rango del portal no se pudo observar",
  "Anual", "NA",
  "Identificador enmascarado (MRUN)",
  "Guia de uso de datos abiertos del DEMRE, guia_uso_datos_abiertos_demre.pdf, presente en la copia local",
  "NA",
