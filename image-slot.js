...
(() => {
  // Handoff/GitHub Pages build: sidecar renamed without the leading dot so
  // GitHub Pages serves it reliably (dotfiles can be skipped by the CDN).
  ...
  class ImageSlot extends HTMLElement {
    ...
    async _ingest(file) {
      ...
      if (!file || ACCEPT.indexOf(file.type) < 0) {
        this._setError('Arrastre una imagen PNG, JPEG, WebP o AVIF.');
        return;
      }
